...
export const TopTelemetryBar: React.FC<TopTelemetryBarProps> = ({
  ...
  <header className="h-12 bg-[#D4CDA4] border-b border-[#15150F] flex items-center px-3 sm:px-4 justify-between text-[11px] lg:text-[10px] uppercase tracking-widest font-bold select-none z-30 shrink-0">
    <div className="flex items-center gap-3 sm:gap-6 overflow-hidden">
      ...
      <div className="flex flex-col bg-[#15150F] text-[#C3E54E] px-2.5 py-1 sm:py-0.5 border border-[#15150F] shadow-[1px_1px_0px_#15150F]">
        <span className="text-[9.5px] lg:text-[7.5px] text-[#D4CDA4] tracking-tighter opacity-70">OWNER PROJECTS</span>
    ...
    <div className="flex items-center gap-1 sm:gap-1.5 shrink-0">
      ...
      <button onClick={onOpenContact} className="min-h-[36px] sm:min-h-0 flex items-center gap-1 px-3 py-1.5 sm:px-2.5 sm:py-1 border border-[#15150F] bg-[#C3E54E] hover:bg-[#15150F] hover:text-[#C3E54E] text-[11px] lg:text-[10px] cursor-pointer" title="Open contact page">
