...
export const ProvenanceBadge: React.FC<{ provenance?: EvidenceProvenance }> = ({ provenance = 'VERIFIED' }) => {
  if (provenance === 'CURATED') {
    return (
      <span className="text-[10px] font-bold px-1.5 py-0.5 bg-[#E2A96B] text-[#15150F] border border-[#15150F] tracking-wider uppercase inline-block">
        CURATED
      </span>
    );
  }
  if (provenance === 'DERIVED') {
    return (
      <span className="text-[10px] font-bold px-1.5 py-0.5 bg-[#8EA9DA] text-[#15150F] border border-[#15150F] tracking-wider uppercase inline-block">
        DERIVED
      </span>
    );
  }
  if (provenance === 'UNAVAILABLE') {
    return (
      <span className="text-[10px] font-bold px-1.5 py-0.5 bg-[#7A3E2E] text-[#D4CDA4] border border-[#15150F] tracking-wider uppercase inline-block">
        UNAVAILABLE
      </span>
    );
  }
  return (
    <span className="text-[10px] font-bold px-1.5 py-0.5 bg-[#15150F] text-[#C3E54E] border border-[#15150F] tracking-wider uppercase inline-block">
      VERIFIED
    </span>
  );
};
    ...
    >
      ...
      <div className="p-2.5 sm:p-3 bg-[#CBC59B]/80 border-b border-[#15150F] flex items-center justify-between shrink-0">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          <span className="hidden sm:inline-block text-[10px] px-1.5 py-0.5 bg-[#15150F] text-[#C3E54E] font-bold">
            LIVE TELEMETRY
          </span>
      ...
      {selectedProject && (
        <div className="flex border-b border-[#15150F] bg-[#DCD6B2]/80 divide-x divide-[#15150F] text-[11.5px] font-mono font-semibold">
          <button
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1 border-b border-[#15150F] pb-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="text-[15px] font-bold text-[#15150F]">{selectedProject.code} // {selectedProject.title}</span>
                </div>
                <span className="text-[10px] px-1.5 py-0.5 bg-[#15150F] text-[#C3E54E] font-bold">
                  ● {selectedProject.status}
                </span>
              </div>
              <p className="text-[12px] text-[#3D3A2C] font-medium leading-snug">
                {selectedProject.tagline}
              </p>
              <div className="flex items-center gap-3 text-[10.5px] text-[#5C5946] mt-1">
            ...
            {activeTab === 'overview' && (
              <div className="flex flex-col gap-3.5">
                ...
                <div>
                  ...
                  <p className="text-[13px] text-[#15150F] bg-[#E2DCB9]/70 p-2.5 border border-[#15150F] leading-relaxed">
                ...
                <div className="flex flex-col gap-2">
                  <div className="p-2.5 border border-[#15150F] bg-[#CBC59B]/30">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-[11px] font-bold text-[#7A3E2E] uppercase block">
                        [ENGINEERING CHALLENGE]
                      </span>
                      <ProvenanceBadge provenance={selectedProject.provenance?.problem} />
                    </div>
                    <p className="text-[13px] text-[#22211A] leading-relaxed">
                  ...
                  <div className="p-2.5 border border-[#15150F] bg-[#CBC59B]/30">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-[11px] font-bold text-[#2E6B3A] uppercase block">
                ...
                <div>
                  ...
                  <div className="mb-2 p-2 bg-[#15150F] text-[#D4CDA4] border border-[#15150F] flex flex-col gap-1">
                    <div className="flex items-center justify-between">
                      <span className="text-[11px] font-bold text-[#C3E54E] uppercase tracking-wider">
                        TIER: {selectedProject.category === 'fullstack' ? 'FULL-STACK' : selectedProject.category.toUpperCase()}
                      </span>
                      <span className="text-[10px] px-1 py-0.5 bg-[#C3E54E] text-[#15150F] font-bold">
                        {selectedProject.techStack.length} TECHNOLOGIES
                      </span>
                    </div>
                    <div className="text-[11.5px] text-[#A8A48B] leading-tight">
                    ...
                    {selectedProject.infrastructureDeps.map(infraId => {
                      ...
                      return (
                        <button
                          ...
                          className="flex items-center gap-1.5 px-2.5 py-1.5 lg:py-1 min-h-[36px] lg:min-h-0 text-[11px] font-semibold bg-[#E2DCB9] border border-[#15150F] hover:bg-[#15150F] hover:text-[#D4CDA4] transition-colors cursor-pointer"
                        >
                  ...
                  <div className="divide-y divide-[#15150F] border border-[#15150F] bg-[#E2DCB9]/40">
                    {selectedProject.subsystems.map((sub, i) => (
                      <div key={sub.id} className="p-2.5 flex flex-col gap-1">
                        <div className="flex items-center justify-between">
                          <span className="font-bold text-[12.5px] text-[#15150F]">0{i+1} // {sub.name}</span>
                          <div className="flex items-center gap-1">
                            <span className="text-[10px] bg-[#15150F] text-[#D4CDA4] px-1">{sub.category}</span>
                            {sub.provenance && <ProvenanceBadge provenance={sub.provenance} />}
                          </div>
                        </div>
                        <p className="text-[13px] text-[#5C5946] leading-snug">{sub.description}</p>
                        {sub.protocol && (
                          <div className="text-[10.5px] text-[#15150F] font-bold">
                            PROTOCOL: {sub.protocol}
                          </div>
                        )}
                        <div className="flex flex-wrap gap-1 mt-0.5">
                          {sub.tech.map(t => (
                            <span key={t} className="text-[10px] px-1 bg-[#DCD6B2] border border-[#15150F]/30 text-[#3D3A2C]">
                              {t}
                            </span>
                          ))}
                        </div>
                    ...
                    {selectedProject.subsystems.length === 0 && (
                      <div className="p-3 text-[13px] text-[#5C5946] leading-relaxed">
                  ...
                  <div className="flex flex-col gap-2">
                    {selectedProject.keyDecisions.map((dec, i) => (
                      <div key={i} className="p-2.5 border border-[#15150F] bg-[#CBC59B]/40 flex flex-col gap-1">
                        <div className="flex items-center justify-between">
                          <div className="font-bold text-[12.5px] text-[#15150F]">
                            DECISION: {dec.decision}
                          </div>
                          {dec.provenance && <ProvenanceBadge provenance={dec.provenance} />}
                        </div>
                        <div className="text-[13px] text-[#3D3A2C]">
                          <span className="font-semibold text-[#5C5946]">RATIONALE: </span>
                          {dec.rationale}
                        </div>
                        <div className="text-[13px] text-[#7A3E2E] bg-[#EFEAD0] p-1 border border-[#15150F]/30">
                    ...
                    {selectedProject.keyDecisions.length === 0 && (
                      <div className="p-3 border border-[#15150F] bg-[#E2DCB9]/50 text-[13px] text-[#5C5946] leading-relaxed">
              ...
              <div className="flex flex-col gap-3.5">
                  ...
                  <div className="grid grid-cols-2 gap-1.5">
                    {selectedProject.metrics.map((m, i) => (
                      <div key={i} className="p-2.5 border border-[#15150F] bg-[#E2DCB9] flex flex-col">
                        <span className="text-[10px] uppercase font-bold opacity-60">{m.label}</span>
                        <span className="text-[14px] font-bold text-[#15150F]">{m.value}</span>
                        {m.note && <span className="text-[10px] opacity-75">{m.note}</span>}
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="p-2.5 border border-[#15150F] bg-[#CBC59B]/40 flex flex-col gap-2">
                    <div className="text-[13px] leading-relaxed text-[#22211A]">
                    ...
                    {selectedProject.validationEvidence && (
                      <div className="flex flex-wrap gap-1 pt-1 border-t border-[#15150F]/20">
                        ...
                        {selectedProject.validationEvidence.testFilesDetected && selectedProject.validationEvidence.testFilesDetected > 0 ? (
                          <span className="text-[10px] px-1.5 py-0.5 bg-[#E2DCB9] text-[#15150F] border border-[#15150F]">
                ...
                <div>
                  ...
                  <div className="p-2.5 border border-[#15150F] bg-[#E2DCB9]/60 text-[13px] text-[#5C5946] leading-relaxed">
            ...
            {activeTab === 'manifest' && (
              <div className="flex flex-col gap-3">
                <div className="text-[11px] font-bold opacity-60 uppercase tracking-wider">
                  SYSTEM MANIFEST &amp; EXTERNAL ARTIFACTS
                </div>
                <div className="p-2.5 border border-[#15150F] bg-[#E2DCB9]/60 font-mono text-[11.5px] flex flex-col gap-1">
                ...
                <div className="flex flex-col gap-2 mt-2">
                  <button
                    ...
                    className="w-full min-h-[44px] lg:min-h-[34px] py-2.5 bg-[#15150F] text-[#C3E54E] font-bold text-[12px] tracking-wider border border-[#15150F] hover:bg-[#2A2920] flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="w-full min-h-[42px] lg:min-h-[32px] py-2 bg-[#E2DCB9] text-[#15150F] font-bold text-[12px] tracking-wider border border-[#15150F] hover:bg-[#15150F] hover:text-[#D4CDA4] flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
                  >
                    <FileText size={13} />
        ...
        {selectedSkill && !selectedProject && (
          <div className="flex flex-col gap-4">
            ...
            <button
              ...
              className="flex items-center gap-1.5 py-1.5 px-2.5 min-h-[36px] lg:min-h-0 bg-[#15150F] text-[#C3E54E] hover:bg-[#2A2920] border border-[#15150F] text-[11px] font-mono font-bold tracking-wider transition-colors cursor-pointer w-fit shadow-[1px_1px_0px_#15150F]"
            ...
            <div className="border-b border-[#15150F] pb-2.5">
              {(() => {
                ...
                return (
                  <>
                    <div className="flex items-center justify-between">
                      <span className="text-[15px] font-bold text-[#15150F]">{selectedSkill.code} // {selectedSkill.name}</span>
                    ...
                    <div className="text-[10.5px] text-[#5C5946] mt-1">
            ...
            <div>
              {(() => {
                ...
                return (
                  <>
                    <div className="text-[11px] font-bold opacity-60 uppercase tracking-wider mb-1.5 flex items-center justify-between">
                      <span>ASSOCIATED SYSTEMS ({matchedProjects.length})</span>
                      <span className="text-[10px] font-mono opacity-80 font-normal">REPOSITORY EVIDENCE ASSOCIATIONS</span>
                    </div>
                    <div className="flex flex-col gap-1.5">
                      {matchedProjects.length === 0 ? (
                        <div className="text-[11px] text-[#5C5946] italic p-2 bg-[#E2DCB9]/40 border border-[#15150F]/40">
                        ...
                        matchedProjects.map(p => (
                          ...
                          >
                            <div className="flex items-center gap-1.5">
                              ...
                              <span className="font-bold text-[11px]">{p.code}</span>
                              <span className="text-[12px] truncate max-w-[170px]">{p.title}</span>
                            </div>
                            <span className="text-[10px] opacity-60 group-hover:text-[#C3E54E]">INSPECT →</span>
                          </button>
                        ))
                      )}
                    </div>
            ...
            <div>
              ...
              <pre className="p-2.5 border border-[#15150F] bg-[#15150F] text-[#D4CDA4] text-[11px] overflow-x-auto leading-tight font-mono whitespace-pre-wrap">
        ...
        {selectedExperience && !selectedProject && !selectedSkill && (
          <div className="flex flex-col gap-4">
            ...
            <div className="border-b border-[#15150F] pb-2.5 flex flex-col gap-1">
              <div className="flex items-center justify-between">
                <span className="text-[15px] font-bold text-[#15150F]">
                  {selectedExperience.code} // {selectedExperience.organization}
                </span>
                <ProvenanceBadge provenance={selectedExperience.provenance || 'CURATED'} />
              </div>
              <div className="flex items-center gap-1.5 text-[12px] text-[#3D3A2C] font-semibold">
                <span>{selectedExperience.role}</span>
                <span>·</span>
                <span>{selectedExperience.location}</span>
              </div>
              <div className="flex items-center justify-between text-[10.5px] text-[#5C5946] mt-0.5 font-mono">
                <span>TIMEFRAME: {selectedExperience.yearRange}</span>
                {selectedExperience.promotionNote && (
                  <span className="text-[10px] px-1 py-0.2 bg-[#2E6B3A] text-[#D4CDA4] font-bold">
                    ↑ {selectedExperience.promotionNote}
                  </span>
                )}
              </div>
            ...
            {selectedExperience.progressionRoles && selectedExperience.progressionRoles.length > 1 && (
              <div>
                <div className="text-[11px] font-bold opacity-60 uppercase tracking-wider mb-1.5 flex items-center justify-between">
                  ...
                  <span className="text-[10px] opacity-75">{selectedExperience.progressionRoles.length} ROLES</span>
                </div>
                <div className="flex flex-col border border-[#15150F] bg-[#E2DCB9]/40 divide-y divide-[#15150F]/30">
                  {selectedExperience.progressionRoles.map((r, i) => (
                    <div key={r.id || i} className="p-2.5 flex flex-col gap-1">
                      <div className="flex items-center justify-between">
                        <span className="font-bold text-[12.5px] text-[#15150F]">
                          {r.role}
                        </span>
                        <div className="flex items-center gap-1">
                          {r.endDate === null && (
                            <span className="text-[10px] px-1 bg-[#15150F] text-[#C3E54E] font-bold">
                              CURRENT
                            </span>
                          )}
                          {r.promotionNote && (
                      ...
                      <div className="text-[10.5px] font-mono text-[#5C5946]">
                        {r.yearRange}
                      </div>
                      {r.keyOutputs && r.keyOutputs.length > 0 && (
                        <p className="text-[13px] text-[#3D3A2C] leading-snug mt-0.5">
                          {r.keyOutputs[0]}
                        </p>
                      )}
                    </div>
                  ...
                  {selectedExperience.architectedSystemsDetails && selectedExperience.architectedSystemsDetails.length > 0 ? (
                    selectedExperience.architectedSystemsDetails.map((arch, idx) => (
                      <div key={idx} className="p-2.5 border border-[#15150F] bg-[#E2DCB9] flex flex-col gap-1.5">
                        <div className="flex items-center justify-between">
                          <span className="font-bold text-[12.5px] text-[#15150F]">{arch.name}</span>
                          <ProvenanceBadge provenance={arch.provenance || 'VERIFIED'} />
                        </div>
                        <p className="text-[13px] text-[#22211A] leading-snug">
                          {arch.description}
                        </p>
                        {arch.architecturalScope && arch.architecturalScope.length > 0 && (
                          <div className="flex flex-wrap gap-1 pt-1 border-t border-[#15150F]/20">
                            {arch.architecturalScope.map((sc, i) => (
                              <span key={i} className="text-[10px] px-1 bg-[#15150F] text-[#D4CDA4] font-mono">
                                {sc}
                              </span>
                            ))}
                          </div>
                        ...
                        {arch.linkedProjectId && (() => {
                          ...
                          return (
                            <button
                              ...
                              className="mt-1 flex items-center justify-between px-2.5 py-1.5 min-h-[38px] lg:min-h-0 bg-[#CBC59B] border border-[#15150F] text-[11.5px] font-bold hover:bg-[#15150F] hover:text-[#D4CDA4] transition-colors cursor-pointer text-left"
                            >
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {selectedExperience.systemsArchitected.map(sys => (
                        <span key={sys} className="px-2 py-1 bg-[#E2DCB9] border border-[#15150F] text-[11px] font-semibold">
                          {sys}
                        </span>
                      ))}
                    </div>
                ...
                <div className="flex flex-col gap-2.5">
                  {selectedExperience.systemsDelivered.map((del, dIdx) => (
                    <div key={dIdx} className="p-2.5 border border-[#15150F] bg-[#E2DCB9]/80 flex flex-col gap-2">
                      <div className="flex items-center justify-between">
                        <span className="font-bold text-[13px] text-[#15150F]">{del.name}</span>
                        <ProvenanceBadge provenance={del.provenance || 'CURATED'} />
                      </div>
                      {del.status && (
                        <div className="text-[10px] font-bold text-[#7A3E2E] bg-[#EFEAD0] px-1.5 py-0.5 border border-[#15150F]/30 w-fit">
                          STATUS: {del.status}
                        </div>
                      )}
                      <p className="text-[13px] text-[#3D3A2C] leading-snug">
                        {del.description || del.tagline}
                      </p>

                      {/* Data Flow Diagram (if present) */}
                      {del.dataFlow && (
                        <div className="p-2 bg-[#15150F] text-[#D4CDA4] border border-[#15150F] text-[11px] font-mono leading-relaxed">
                          <span className="text-[#C3E54E] font-bold block mb-0.5 text-[11px]">DATA INGESTION PIPELINE:</span>
                          {del.dataFlow}
                        </div>
                      )}
                      ...
                      {del.capabilities && del.capabilities.length > 0 && (
                        <div className="flex flex-col gap-0.5 pt-1 border-t border-[#15150F]/20">
                          <span className="text-[10px] font-bold opacity-60 uppercase">SYSTEM CAPABILITIES:</span>
                          {del.capabilities.map((cap, cIdx) => (
                            <div key={cIdx} className="flex items-start gap-1 text-[13px] text-[#22211A]">
                      ...
                      {del.surfaces && del.surfaces.length > 0 && (
                        <div className="flex flex-col gap-1.5 pt-1 border-t border-[#15150F]/20">
                          <span className="text-[10px] font-bold opacity-60 uppercase">PLATFORM SURFACES:</span>
                          <div className="divide-y divide-[#15150F]/20 bg-[#DCD6B2]/60 border border-[#15150F]/30">
                            {del.surfaces.map((sfc, sIdx) => (
                              <div key={sIdx} className="p-2 flex flex-col gap-1">
                                <div className="flex items-center justify-between">
                                  <span className="font-bold text-[12px] text-[#15150F]">
                                ...
                                <p className="text-[13px] text-[#5C5946] leading-snug pl-3">
                                  {sfc.role}
                                </p>
                                <div className="flex flex-wrap gap-1 pl-3 mt-0.5">
                                  {sfc.tech.map(t => (
                                    <span key={t} className="text-[10px] px-1 bg-[#E2DCB9] text-[#15150F] border border-[#15150F]/30 font-mono">
                                      {t}
                                    </span>
                                  ))}
                                </div>
                                {sfc.linkedProjectId && (() => {
                                  ...
                                  return (
                                    <div className="pl-3 mt-1">
                                      <button
                                        onClick={() => onSelectProject(resolved.id)}
                                        className="flex items-center gap-1 px-2 py-1 min-h-[36px] lg:min-h-0 bg-[#15150F] text-[#D4CDA4] hover:bg-[#C3E54E] hover:text-[#15150F] text-[11px] font-bold transition-colors cursor-pointer"
                                      >
                  ...
                  {selectedExperience.engineeringContributions && selectedExperience.engineeringContributions.length > 0 ? (
                    selectedExperience.engineeringContributions.map((contrib, i) => (
                      <div key={i} className="flex flex-col gap-0.5 border-b border-[#15150F]/20 pb-1.5 last:border-b-0 last:pb-0">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-1 text-[12.5px] font-bold text-[#15150F]">
                            <span className="text-[#2E6B3A]">✓</span>
                            <span>{contrib.title}</span>
                          </div>
                          <ProvenanceBadge provenance={contrib.provenance || 'CURATED'} />
                        </div>
                        <p className="text-[13px] text-[#22211A] leading-snug pl-3">
                          {contrib.description}
                        </p>
                        {contrib.impactArea && (
                          <div className="pl-3 mt-0.5">
                            <span className="text-[10px] px-1 bg-[#15150F] text-[#8EA9DA] font-mono">
              ...
              <div>
                ...
                <div className="p-2.5 border border-[#15150F] bg-[#E2DCB9]/60 flex flex-col gap-2">
                  {selectedExperience.infrastructureOperations.map((infra, i) => (
                    <div key={i} className="flex flex-col gap-0.5 border-b border-[#15150F]/20 pb-1.5 last:border-b-0 last:pb-0">
                      <div className="flex items-center justify-between">
                        <span className="text-[12px] font-bold text-[#15150F]">
                          0{i + 1} // {infra.area}
                        </span>
                        {infra.status && (
                          <span className="text-[10px] px-1 bg-[#15150F] text-[#C3E54E] font-bold">
                ...
                <div className="flex flex-col gap-1.5">
                  {selectedExperience.evidenceLinks.map((link, i) => (
                    <div key={i} className="flex flex-col gap-1 p-2 bg-[#E2DCB9] border border-[#15150F]">
                      <div className="flex items-center justify-between">
                        <span className="font-bold text-[12px]">{link.label}</span>
                        <span className="text-[10px] px-1 bg-[#15150F] text-[#8EA9DA] uppercase font-bold">
                          {link.type}
                        </span>
                      </div>
                      {link.note && <p className="text-[12px] text-[#5C5946]">{link.note}</p>}
                      <div className="flex items-center gap-1.5 mt-1">
                        {link.projectId && (() => {
                          const resolved = resolveProjectFromEvidenceKey(projects, link.projectId);
                          if (!resolved) {
                            return (
                              <span className="flex-1 py-1 text-[10px] font-mono text-[#5C5946] italic text-center">
                          ...
                          return (
                            <button
                              onClick={() => onSelectProject(resolved.id)}
                              className="flex-1 py-1.5 min-h-[38px] lg:min-h-0 bg-[#15150F] text-[#C3E54E] hover:bg-[#2A2920] font-bold text-[11px] tracking-wider transition-colors flex items-center justify-center gap-1 cursor-pointer"
                            >
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1">
                  {selectedExperience.technologies.map(t => (
                    <span key={t} className="text-[10.5px] px-1.5 py-0.5 bg-[#15150F] text-[#D4CDA4] font-bold">
                      {t}
                    </span>
                  ))}
                </div>
            ...
            {activeView === 'identity' ? (
              ...
              <>
                ...
                <div className="border-b border-[#15150F] pb-3">
                  <div className="flex items-center justify-between">
                    <span className="text-[15px] font-bold text-[#15150F]">{activeOperator.name}</span>
                    <span className="text-[10px] bg-[#15150F] text-[#C3E54E] px-1.5 py-0.5 font-bold">
                      {activeOperator.status || 'ACTIVE'}
                    </span>
                  </div>
                  <div className="text-[12px] text-[#5C5946] font-semibold mt-0.5">
                    {activeOperator.handle} · {activeOperator.role}
                  </div>
                  <div className="text-[11px] text-[#5C5946] mt-0.5">
                    LOCATION: {activeOperator.location}
                  </div>
                  <div className="text-[13px] text-[#3D3A2C] mt-1 font-medium bg-[#E2DCB9]/60 p-2 border border-[#15150F]/40 leading-relaxed">
                ...
                <div className="grid grid-cols-2 gap-1.5">
                  <div className="p-2 border border-[#15150F] bg-[#E2DCB9] flex flex-col">
                    <span className="text-[10px] opacity-60 uppercase font-bold">PUBLIC PROJECTS</span>
                    <span className="text-[14px] font-bold text-[#15150F]">
                      {projects.length} MAPPED
                    </span>
                  </div>
                  <div className="p-2 border border-[#15150F] bg-[#E2DCB9] flex flex-col">
                    <span className="text-[10px] opacity-60 uppercase font-bold">CAREER ORGANIZATIONS</span>
                    <span className="text-[14px] font-bold text-[#15150F]">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1">
                    {activeOperator.primaryStack.map(st => (
                      <span key={st} className="text-[10.5px] px-2 py-0.5 bg-[#15150F] text-[#D4CDA4] font-bold">
                        {st}
                      </span>
                    ))}
                  </div>
                ...
                <div>
                  ...
                  <div className="flex flex-col border border-[#15150F] bg-[#E2DCB9]/40 divide-y divide-[#15150F]/20">
                    {experience.map((exp) => (
                      <div key={exp.id} className="p-2 flex items-center justify-between text-[11.5px]">
                        <div>
                          <span className="font-bold text-[#15150F]">{exp.organization}</span>
                          <span className="text-[#5C5946] block text-[10.5px]">{exp.role}</span>
                        </div>
                        <span className="text-[10px] font-mono text-[#15150F] opacity-75">{exp.yearRange}</span>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <>
                <div className="border-b border-[#15150F] pb-2.5">
                  <span className="text-[10px] bg-[#15150F] text-[#C3E54E] px-1.5 py-0.5 font-bold uppercase tracking-wider">
                    SYSTEM TOPOLOGY // {projects.length} REPOSITORIES
                  </span>
                  <div className="text-[15px] font-bold text-[#15150F] mt-1.5">
                    PROJECT LANDSCAPE EXPLORER
                  </div>
                </div>
                <div className="p-3 border border-[#15150F] bg-[#E2DCB9] text-[13px] text-[#22211A] leading-relaxed flex flex-col gap-2">
                  <p>
                    Select any repository node on the canvas to inspect architectural blueprints, tech stacks, and live telemetry.
                  </p>
                  <div className="p-2.5 bg-[#15150F] text-[#D4CDA4] text-[11.5px] font-mono flex flex-col gap-1">
              ...
              <div className="flex flex-col gap-3">
                <div className="border-b border-[#15150F] pb-2 flex flex-col gap-0.5">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-mono text-[#5C5946]">{experience.length} ROLES RECORDED</span>
                  </div>
                  <div className="text-[15px] font-bold text-[#15150F] mt-1">
                    PROFESSIONAL EXPERIENCE INDEX
                  </div>
                </div>
                  ...
                  {groupedExperience.map((org) => {
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-1.5">
                            <span className="font-bold text-[13px] uppercase tracking-tight group-hover:text-[#C3E54E]">
                              {org.code} // {org.organization}
                            </span>
                            {org.promotionNote && (
                              <span className="text-[10px] px-1 py-0.2 bg-[#2E6B3A] text-[#D4CDA4] font-bold group-hover:bg-[#C3E54E] group-hover:text-[#15150F]">
                                PROMOTED
                              </span>
                            )}
                          </div>
                        ...
                        <div className="flex flex-col text-[12px]">
                          ...
                          <span className="text-[10.5px] text-[#5C5946] group-hover:text-[#A8A48B] font-mono">
                            {org.organizationTenure}
                          </span>
                        </div>

                        <div className="flex items-center justify-between pt-1 border-t border-[#15150F]/20 group-hover:border-[#D4CDA4]/20 text-[10px] font-mono">
              ...
              <div className="flex flex-col gap-3">
                <div className="border-b border-[#15150F] pb-2 flex flex-col gap-0.5">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-mono text-[#5C5946]">COMMONLY DETECTED TECH</span>
                  </div>
                  <div className="text-[15px] font-bold text-[#15150F] mt-1">
                    TECHNICAL CAPABILITIES INDEX
                  </div>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-[10px] font-bold px-1.5 py-0.5 bg-[#15150F] text-[#D4CDA4] group-hover:bg-[#C3E54E] group-hover:text-[#15150F] border border-[#15150F] tracking-wider uppercase">
                            {skill.category.toUpperCase()}
                          </span>
                        </div>

                        {skill.primaryUseCases && skill.primaryUseCases.length > 0 && (
                          <p className="text-[13px] text-[#3D3A2C] group-hover:text-[#D4CDA4] leading-snug line-clamp-2">
                ...
                <div className="p-2 bg-[#CBC59B]/50 border border-[#15150F]/30 text-[10px] text-[#5C5946] font-mono">
              ...
              <>
                ...
                <div className="border-b border-[#15150F] pb-2.5">
                  ...
                  <p className="text-[13px] text-[#5C5946] mt-1 leading-snug">
                ...
                <div className="grid grid-cols-3 gap-1">
                  <div className="p-2 border border-[#15150F] bg-[#E2DCB9] flex flex-col">
                    <span className="text-[10px] opacity-60 uppercase font-bold">REPOSITORIES</span>
                    <span className="text-[14px] font-bold text-[#15150F]">{projects.length}</span>
                  </div>
                  <div className="p-2 border border-[#15150F] bg-[#E2DCB9] flex flex-col">
                    <span className="text-[10px] opacity-60 uppercase font-bold">CAPABILITIES</span>
                    <span className="text-[14px] font-bold text-[#15150F]">{skills.length}</span>
                  </div>
                  <div className="p-2 border border-[#15150F] bg-[#E2DCB9] flex flex-col">
                    <span className="text-[10px] opacity-60 uppercase font-bold">CAREER ROLES</span>
                    <span className="text-[14px] font-bold text-[#15150F]">{experience.length}</span>
                  </div>
                </div>

                {/* Manifesto / Summary */}
                <div>
                  <div className="text-[11px] font-bold opacity-60 uppercase tracking-wider mb-1">
                    SYSTEM MANIFESTO
                  </div>
                  <p className="text-[13px] text-[#22211A] bg-[#E2DCB9]/80 p-2.5 border border-[#15150F] leading-relaxed">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-1 text-[10.5px] font-mono">
                    <div className="p-1.5 bg-[#15150F] text-[#C3E54E] border border-[#15150F] flex flex-col">
                      ...
                      <span className="text-[10px] text-[#A8A48B] leading-tight">Public GitHub files, manifests, and code</span>
                    </div>
                    <div className="p-1.5 bg-[#E2A96B]/30 text-[#15150F] border border-[#15150F] flex flex-col">
                      ...
                      <span className="text-[10px] text-[#5C5946] leading-tight">Reviewed LinkedIn import / owner evidence</span>
                    </div>
                    <div className="p-1.5 bg-[#CBC59B] text-[#15150F] border border-[#15150F] flex flex-col">
                      ...
                      <span className="text-[10px] text-[#5C5946] leading-tight">Multi-signal heuristic classifications</span>
                    </div>
                    <div className="p-1.5 bg-[#E2DCB9] text-[#7A3E2E] border border-[#15150F] flex flex-col">
                      <span className="font-bold">○ UNAVAILABLE</span>
                      <span className="text-[10px] text-[#5C5946] leading-tight">Unclaimed / unestablished evidence gap</span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <div className="text-[11px] font-bold opacity-60 uppercase tracking-wider mb-1.5 flex items-center justify-between">
                    ...
                    <span className="text-[10px] text-[#C3E54E] bg-[#15150F] px-1 py-0.2 font-mono font-bold">
                  ...
                  <div className="flex flex-col gap-1.5 border border-[#15150F] bg-[#E2DCB9]/40 p-2 divide-y divide-[#15150F]/20">
                    {VERIFIED_ARCHITECTURE_PRINCIPLES.map((pr) => (
                      <div key={pr.id} className="pt-1.5 first:pt-0 flex flex-col gap-0.5">
                        ...
                        <p className="text-[13px] text-[#22211A] font-medium leading-snug">
                          {pr.summary}
                        </p>
                        <p className="text-[13px] text-[#5C5946] leading-tight">
                          {pr.elaboration}
                        </p>
                      </div>
                    ))}
