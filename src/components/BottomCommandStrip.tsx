...
export const BottomCommandStrip: React.FC<BottomCommandStripProps> = ({
  ...
  return (
    <div className="hidden lg:flex flex-col select-none z-30 shrink-0">
      ...
      <footer className="h-10 border-t border-[#15150F] flex items-center px-4 text-[11px] uppercase gap-4 sm:gap-6 font-bold bg-[#CBC59B] text-[#15150F] overflow-x-auto whitespace-nowrap justify-between">
        ...
        <div className="flex items-center gap-3 ml-auto shrink-0">
          ...
          <div className="flex items-center gap-1 px-1.5 py-0.5 border border-[#15150F] bg-[#D4CDA4] text-[10px] font-bold">
      ...
      <footer className="h-6 bg-[#15150F] text-[#D4CDA4] text-[10px] flex items-center px-4 justify-between tracking-widest font-mono shrink-0 select-none">
